...
import sys
sys.path.append('/root/chq/LLaVA/llava/train')
from llava.train.dataloader_progen import CATH_ESM_Dataset
def make_supervised_data_module(train_path, eval_path):

    train_dataset = CATH_ESM_Dataset.from_folder(train_path)
    eval_dataset = CATH_ESM_Dataset.from_folder(eval_path)
    datacollator = eval_dataset.collator
...
def train():
    ...
    progen_tokenizer = '/root/progen2/tokenizer.json'
    ...
    tokenizer = progen_tokenizer    
    logging.info('Progen Check')
    ...
    train_path = '/root/cath3w_/train'
    eval_path = '/root/cath3w_/valid'
    data_module = make_supervised_data_module(train_path, eval_path)
